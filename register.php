...
$translations = [
    'ro' => [
        ...
        'register_title' => 'Creeaza cont',
        'nav_login' => 'Autentificare',
        'auth_subtitle' => 'Incepe sa-ti controlezi cheltuielile.',
    ...
    'en' => [
        ...
        'nav_login' => 'Sign in',
        'auth_subtitle' => 'Start taking control of your expenses.',
...
<header class="auth-header">
    ...
    <div class="auth-header-right">
        <a href="login.php" class="auth-switch-btn"><?= $t['nav_login'] ?></a>
